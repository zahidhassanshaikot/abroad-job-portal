          ...
          <div class="col-12">
            <div class="section-content">
              <div class="content-head">
                <h4 class="content-title">Total Apply for <span class="job-title">Sytstem Architect</span></h4><!-- /.content-title -->
              </div><!-- /.content-head -->
                    ...
                    <tr>
                      ...
                      <td class="action">
                        <ul>
                          ...
                          <li><a href="#" class="warning">Pending</a></li>
                          <li><a href="#" class="danger">Eleminate</a></li>
                        </ul>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="action">
                        <ul>
                          <li><a href="candidate-profile.php" target="blank" class="profile">Profile</a></li>
                          <li><a href="#" class="success">Select</a></li>
                          <li><a href="#" class="warning">Pending</a></li>
                          <li><a href="#" class="danger">Eleminate</a></li>
                        </ul>
                      </td>
