      ...
      <div class="row">
        <div class="col-lg-6 offset-md-3">
          <div class="login-content bg-light">
            <div class="login-logo pt-4 pb-3 background-bg" data-image-src="{{asset('design')}}/images/we.jpg">
              <a href="index.php">
            ...
            <div class="login-form">
                <form action="{{ route('login')}}" method="POST">
                    {{-- <form action="job-seeker-dashboard.php"> --}}
      @csrf
                ...
                <div class="register-link mt-1 text-center">
                  <p>Don't have account ? <a href="{{ route('company-register') }}"> Sign Up Here</a></p>
                </div>
              </form>
            </div>
          </div>
