            ...
            <div class="col-md-12">
              <div class="section-content profile-dashboard">
                <div class="content-head">
                  ...
                  <h2 class="name"><?php echo e($seeker_profile->fname); ?> <?php echo e($seeker_profile->lname); ?></h2>
                    <h5 class="email"><?php echo e($seeker_profile->email); ?></h5>
                  </div>
                </div>
                          ...
                          <div class="applier-info">
                            ...
                            <table class="table table-striped">
                              <tbody>
                                <tr>
                                  <td>Email Address</td>
                                  <td><?php echo e($seeker_profile->email); ?></td>
                                </tr>
                                <tr>
                                  <td>Fisrt Name</td>
                                  <td><?php echo e($seeker_profile->fname); ?></td>
                                </tr>
                                <tr>
                                  <td>Last Name</td>
                                  <td><?php echo e($seeker_profile->lname); ?></td>
                                </tr>
                                <tr>
                                  <td>Phone</td>
