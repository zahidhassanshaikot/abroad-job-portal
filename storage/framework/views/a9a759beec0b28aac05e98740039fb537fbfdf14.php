  ...
  <div class="admin-register d-flex align-content-center flex-wrap">
    <div class="container">
      <div class="register-content bg-light">
        <div class="register-logo pt-4 pb-3 background-bg" data-image-src="<?php echo e(asset('design')); ?>/images/we.jpg">
          <a href="index.php">
        ...
        <form action="<?php echo e(route('save-job-seeker-reg-info')); ?>" method="POST">
          <?php echo csrf_field(); ?>
            ...
            <div class="register-link mt-1 text-center">
              <p>Already have account ? <a href="<?php echo e(route('login-job-seeker')); ?>"> Log in</a></p>
            </div>
          </form>
        </div>
      </div>
