            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="lname" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Phone No')); ?></label>

                            <div class="col-md-6">
                                <input id="Phone_no" type="text" class="form-control<?php echo e($errors->has('Phone_no') ? ' is-invalid' : ''); ?>" name="Phone_no" value="<?php echo e(old('Phone_no')); ?>" required autofocus>
