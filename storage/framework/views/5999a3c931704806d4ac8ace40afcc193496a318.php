  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-12 col-lg-8">
        ...
        <form class="message-form" action="<?php echo e(route('send-message')); ?>" method="post">
              <h3>Send Your Message</h3>
              <?php echo csrf_field(); ?>
              <textarea name="message" class="message-tm" rows="8" cols="80"></textarea>
        <input type="hidden" name="job_post_id" class="submit-tm" value="<?php echo e($job_post_id); ?>">
        <input type="hidden" name="reciver_id" class="submit-tm" value="<?php echo e($reciver_id); ?>">
