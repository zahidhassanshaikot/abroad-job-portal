  ...
  <link rel="stylesheet" href="<?php echo e(asset('design')); ?>/assets/css/pe-icon-7-stroke.css">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('design')); ?>/assets/css/index-01.css">
    ...
    <div class="top-right media-body">
      ...
      <div class="right-content float-right">
        ...
        <div class="dropdown user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo e(asset('design')); ?>/images/avatar/1.jpg" class="rounded-circle float-left mr-2" alt="User Image">
            <span class="status"></span>
          <h4 class="name"><?php echo e(Auth::user()->lname); ?></h4>
          </a>
          <ul class="dropdown-menu">
